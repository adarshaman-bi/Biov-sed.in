...
export default function TestSeriesConsole() {
      ...
      try {
        ...
        snap.forEach((docSnap) => {
          ...
          list.push({
            ...
            associatedSubjectIds: d.associatedSubjectIds || [],
            topicTags: d.topicTags || [],
            totalDurationMinutes: d.totalDurationMinutes || 180,
            passingScoreThreshold: d.passingScoreThreshold || 50,
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Save to Firebase
      const docRef = doc(db, 'tests', selected.id);
      await setDoc(docRef, selected, { merge: true });

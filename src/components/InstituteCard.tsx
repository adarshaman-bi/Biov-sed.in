...
export function InstituteCard({ institute, onViewHub }: InstituteCardProps) {
  return (
    <div className="bg-[#0E0E10] border border-zinc-900/90 w-full rounded-2xl overflow-hidden hover:border-zinc-750 hover:shadow-[0_4px_30px_rgba(0,0,0,0.85)] transition-all duration-300 flex flex-col justify-between group">
      ...
      <div className="relative w-full h-28 overflow-hidden bg-[#0A0A0C] border-b border-zinc-900">
        ...
        {(institute.isVerified || institute.verified) && (

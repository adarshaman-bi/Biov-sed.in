...
export function BatchCard({ batch, onClick }: BatchCardProps) {
  ...
  return (
    <div 
      onClick={onClick}
      className="bg-[#0E0E10] border border-zinc-900/90 hover:border-zinc-750 rounded-2xl p-4 flex flex-col sm:flex-row gap-4 transition-all duration-300 hover:shadow-[0_4px_24px_rgba(0,0,0,0.8)] relative group overflow-hidden cursor-pointer"
    >
